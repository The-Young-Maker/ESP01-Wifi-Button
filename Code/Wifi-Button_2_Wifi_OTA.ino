...
File fsUploadFile;
const char *APssid = "ESP_Button";  // Change this to your desired SSID
const char *APpass = "wifibutton";  // Change this to your desired Password
...
//start Config. Mode
    ...
    ArduinoOTA.setHostname("ESP_Button"); // Change this to your desired OTA Hostname
    ArduinoOTA.setPassword("wifibutton"); // Change this to your desired OTA Password
    ...
    while (WiFi.status() != WL_CONNECTED) {
      ...
      if (failCount == wc_p * 2) {
        Serial.println("Failed to connect to first WiFi, trying second WiFi");
...
void readConfig() {
  ...
  DeserializationError err = deserializeJson(jsonDoc, buf.get());
  ...
  ssid1 = jsonDoc["ssid1"].as<String>();
  password1 = jsonDoc["pass1"].as<String>();
  ssid2 = jsonDoc["ssid2"].as<String>();
  password2 = jsonDoc["pass2"].as<String>();
  host = jsonDoc["host"].as<String>();
  url = jsonDoc["uri"].as<String>();
  wc_p = jsonDoc["wc_p"];
  gr_p = jsonDoc["gr_p"];
  s_vcc = jsonDoc["s_vcc"];
  is_ip = jsonDoc["is_ip"];
  vcc_parm = jsonDoc["vcc_p"].as<String>();

  Serial.println("Parsed JSON Config.");
  Serial.print("Loaded ssid 1: ");
  Serial.println(ssid1);
  Serial.print("Loaded password 1: ");
  Serial.println(password1);
  Serial.print("Loaded ssid 2: ");
  Serial.println(ssid2);
  Serial.print("Loaded password 2: ");
